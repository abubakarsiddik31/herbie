...
export function WorkflowRunsDialog({ workflowId, open, onOpenChange }: WorkflowRunsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl lg:max-w-5xl h-[85vh] max-h-[85vh] w-full flex flex-col p-0 overflow-hidden">
        ...
        <div className="flex flex-1 min-h-0 min-w-0 divide-x divide-border">
          ...
          <div className="flex-1 min-h-0 min-w-0 bg-muted/20 overflow-y-auto p-4 space-y-4 text-xs">
            {!activeRun ? (
