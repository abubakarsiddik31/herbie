...
export const TEMPLATES: ToolTemplate[] = [
  ...
  },
  {
    ...
    tool: {
      ...
      params: [
        { name: "name", in: "query", type: "string", required: true, description: "City or place name to look up" },
  ...
  },
  {
    ...
    tool: {
      ...
      bodyTemplate: "",
      headers: { Accept: "application/vnd.github+json", "User-Agent": "Herbie/1.0" },
      requireApproval: false,
      enabled: true,
    },
  },
  {
    ...
    tool: {
      ...
      params: [
        { name: "q", in: "query", type: "string", required: true, description: "Search keywords, e.g. go cli" },
  ...
  },
  {
    ...
    title: "Dictionary",
    category: "News & knowledge",
    tagline: "Definitions and meanings for English words",
    icon: BookMarked,
    tool: {
      name: "define_word",
      description: "Get dictionary definitions, meanings, and usage for an English word.",
      method: "GET",
      urlTemplate: "https://en.wiktionary.org/api/rest_v1/page/definition/{{word}}",
      params: [
